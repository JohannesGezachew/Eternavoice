        ...
        {step === "voice" ? (
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setStep("who")}
              className="w-fit cursor-pointer text-[13px] text-[var(--color-text-tertiary)] transition-colors hover:text-[var(--color-bone)]"
            >
              ← Back
            </button>
          </motion.section>
      ...
      <div className="mt-8 rounded-2xl border border-[var(--color-rule)] bg-white/[0.02] p-6 sm:p-7">
        {loading ? (
          ...
          <div className="flex flex-col gap-5">
            <audio ref={audioRef} src={previewUrl} controls preload="auto" className="w-full" />
