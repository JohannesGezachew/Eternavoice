  ...
  return (
    <div className="flex min-h-dvh w-full flex-col bg-[var(--color-ink)] text-[var(--color-bone)]">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center px-6 py-14 text-center sm:px-8 sm:py-20">
        ...
        <h1 className="font-serif mt-5 text-display leading-[1.08] tracking-[-0.02em] text-balance sm:text-hero">
          This is what a conversation looks like.
        </h1>
        <p className="mt-4 max-w-md text-body leading-[1.7] text-[var(--color-text-secondary)]">
        ...
        <div className="mt-10 flex flex-col items-center gap-4">
          ...
          <p className="max-w-xs text-small leading-[1.7] text-[var(--color-text-tertiary)]">
